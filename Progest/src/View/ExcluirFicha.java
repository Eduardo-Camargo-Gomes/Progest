...
public class ExcluirFicha extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LabelInsiraID.setText("Insira o número da ficha que desejas excluir");
  ...
  int numFicha = Integer.parseInt(CampoIDFicha.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExcluirFicha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
